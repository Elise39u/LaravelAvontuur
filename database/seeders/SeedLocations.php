 ...
 You only see newyork from you`re apartment  <br>
  Should you go outside or stay inside is the question', 'foto_url' => '/img/kitchen.png']);
    ...
    Do we go left or right?', 'foto_url' => '/img/shore.png']);
        ...
        DB::table('choices')->insert(['name' => 'Go to the pizzeria ', 'from_location_id' => 80, 'to_location_id' => 91]); // Only when its 23:30 - 24:00 and have Coach Elise in their party

        DB::table('locations')->insert(['id' => 90, 'name' => 'Time to het bleach', 'area_id' => 1, 'title' => 'Are you sure?', 'story' => 'Well as you approach the studio Coach Elise looks to you <br>
        <b>Coach Elise:</b> Well this place is dangerous enough at least to say<br>
        ...
        DB::table('locations')->insert(['id' => 92, 'name' => 'Playtime', 'area_id' => 6, 'title' => 'Cartoon time', 'story' => '<b>Coach Elise:</b> this place doens`t look that bad <br>
        <b>username:</b> Well perhaps you don`t know <br>
        But everywhere its seems ink is leaking fron the sealing <br>
        <b>Coach Elise:</b> well that ink we can wash away so come on <br>
        ...
        DB::table('locations')->insert(['id' => 93, 'name' => 'Playtime', 'area_id' => 6, 'title' => 'Time to choose', 'story' => '<b>Coach Elise:</b> well found anything username? <br>
        <b>username:</b> Nope only this <br>
        Should we check if the projector it does <br>
        <b>Coach Elise:</b> At least we could try that <br>
        ...
        <b>Coach Elise:</b> We will see', 'foto_url' => '/img/minigame/bendy_ch1/bendy_openarea_ch1.png']);
        ...
        DB::table('locations')->insert(['id' => 96, 'name' => 'Playtime', 'area_id' => 6, 'title' => 'Time for answers', 'story' => '<b>Coach Elise:</b> well want me to turn it on? <br>
        <b>username:</b> Perhaps its has answers <br>
        <b>Coach Elise:</b> That could be but we don`t know that <br>
        ...
        <b>username:</b> You and coach Elise look weird and say yes <br>
        ...
        <b>Coach Elise:</b> And if we fail? <br>
