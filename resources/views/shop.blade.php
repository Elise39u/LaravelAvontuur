...
@section('content')
    ...
    <div class="col-md-10 card bg-light mb-3">
        ...
        <div class="card-body">
            ...
            <p> You currently have <strong>{{$user['inbank']}}</strong> in bank and <strong>{{$user['gold']}}</strong>
                gold in hand</p>
            @endif <br>
                    ...
                    <form class="shop" action="{{action('HomeController@weaponBuy')}}" method="post">
                        ...
                        @else
                            <form class="shop" action="{{action('HomeController@checkBuy')}}" method="post">
                                <strong>{{$shopitems[$i]['name']}} </strong> <em>{{$shopitems[$i]['price']}}gold</em>
                                <br>
                                <input type="hidden" name="id" value="{{$shopitems[$i]['id']}}">
                                <input type="hidden" name="price" value="{{$shopitems[$i]['price']}}">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            ...
                            @if (isset($toomuch))
                                <div class="alert alert-danger alert-dismissable"><a href="#" class="close"
                                                                                     data-dismiss="alert"
                                                                                     aria-label="close">&times;</a><strong>Gold
                                        Problems</strong>
                                    <ul>
                                        <li>{{$toomuch}}</li>
                                    </ul>
                            ...
                            @if (isset($cost))
                                <div class="alert alert-danger alert-dismissable"><a href="#" class="close"
                                                                                     data-dismiss="alert"
                                                                                     aria-label="close">&times;</a><strong>Negatives
                                        numbers</strong>
                                    <ul>
                                        <li>{{$cost}}</li>
                                    </ul>
                            ...
                            @if (isset($error))
                                <div class="alert alert-danger alert-dismissable"><a href="#" class="close"
                                                                                     data-dismiss="alert"
                                                                                     aria-label="close">&times;</a><strong>Errors</strong>
                                    <ul>
                                        <li>{{$error}}</li>
                                    </ul>
                                </div>
                            @endif
                            <li class="menuchoice"><a class="link" href="/location/{{$shop['location_id']}}"> Go
                                    back</a></li>
        </div>
    </div>
@endsection
